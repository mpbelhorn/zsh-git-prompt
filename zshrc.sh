...
export __GIT_PROMPT_DIR=~/.bin/zsh-git-prompt
# Initialize colors.
autoload -U colors
colors
...
ZSH_THEME_GIT_PROMPT_STAGED="%{$fg[green]%}s"
ZSH_THEME_GIT_PROMPT_CHANGED="%{$fg[red]%}m"
ZSH_THEME_GIT_PROMPT_CONFLICTS="%{$fg[yellow]%}c"
